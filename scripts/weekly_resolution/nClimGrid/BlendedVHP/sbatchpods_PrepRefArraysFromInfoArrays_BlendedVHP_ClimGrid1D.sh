...
/usr/local/other/PoDS/PoDS/pods.py -n 4 -l Y -s Y  -x /discover/nobackup/syatheen/Sujay/DeepLearning/ExampleTries/NIDIS/Execfile_PrepRefArraysFromInfoArrays_BlendedVHP_ClimGrid1D
