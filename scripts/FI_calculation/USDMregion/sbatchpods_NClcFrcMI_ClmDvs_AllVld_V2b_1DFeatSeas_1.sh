...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/ExampleTries/NIDIS/Execfile_ClcFrcMI_ClmDvs_AllVld_V2b_1DFeat_NewSeas_1 -n 15
conda deactivate 
exit 0
