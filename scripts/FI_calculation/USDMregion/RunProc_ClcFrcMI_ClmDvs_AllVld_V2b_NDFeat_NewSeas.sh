...
#which python
python CalcFracMI_ClimDivs_AllValid_V2b_NDFeat_NewSeas.py ${args[0]} ${args[1]} ${args[2]} ${args[3]} ${args[4]} ${args[5]} ${args[6]} ${args[7]} ${args[8]} ${args[9]} >& MI_results/NClcFrcMI_ClmDvs_AllVld_V2b_ND_${args[0]}${args[1]}${args[2]}${args[4]}${args[5]}_${args[6]}_${args[7]}_${args[8]}_${args[9]}.out
conda deactivate
