...
do
    ...
    sbatch -J "NID_${1}" /discover/nobackup/syatheen/development/nidis/scripts/indicators_calculation/soni_sbatch_submission_single_indicator_multi_epoch.sh $1 "$2" $3 $start_task $end_task $4
