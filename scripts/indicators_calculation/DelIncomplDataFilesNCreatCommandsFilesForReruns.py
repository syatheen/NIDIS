...
Command_Part1 = 'python /discover/nobackup/syatheen/development/nidis/nidis/view/CalcFI1X1_ClimGrid1D_V2b_NDFeat_NewSeas_CLI.py --indicator --season U --init-task ' 
...
for WhichPixel in range(NumPixels):
    ...
    if os.path.exists(PixelFileName):
        xx = np.loadtxt(PixelFileName)
        if xx.shape[0] != 3:
            os.system('rm -rf ' + PixelFileName)
