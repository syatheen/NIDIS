...
##NUMBER_NODES=100 # for -10
##NUMBER_NODES=175 # for -12
NUMBER_NODES=250 # for -15
...
do
    ...
    sbatch -J "NID_${1}" /discover/nobackup/mosman1/development/nidis/scripts/indicators_calculation/mahmoud_sbatch_submission_single_indicator_multi_epoch.sh $1 "$2" $3 $start_task $end_task $4
