...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/nClimGrid/Execfile_CreateTifs_spei-60 -n 14
conda deactivate 
exit 0
