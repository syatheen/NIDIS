...
#SBATCH --ntasks=6300 --ntasks-per-node=28
#SBATCH --job-name=IMRG
...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/IMERG/Execfile_CreateTifs -n 28
conda deactivate 
exit 0
