...
srun -n1 python /discover/nobackup/jacaraba/development/nidis/nidis/view/CalcFI1X1_ClimGrid1D_V2b_NDFeat_NewSeas_CLI.py --indicator $1 --season $2 --output-dir /discover/nobackup/projects/$3/jacaraba/NIDIS_Runs --step training --init-task 0 --end-task 469758
