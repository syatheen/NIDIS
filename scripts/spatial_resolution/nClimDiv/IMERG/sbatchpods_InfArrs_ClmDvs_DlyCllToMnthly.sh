...
#SBATCH --ntasks=252 --ntasks-per-node=3
#SBATCH --job-name=IMR
...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/IMERG/Execfile_InfoArrays_ClimDivs_DailyCollToMonthly -n 3
conda deactivate 
exit 0
