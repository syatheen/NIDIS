...
#which python
python InfoArrays_ClimDivs_DailyCollToMonthly.py ${args[0]} ${args[1]}  >& /discover/nobackup/projects/nca/syatheen/IMERG_Outs/daily_Final_V06/InfoArrs_ClmDvs_DlyCllToMnthly_${args[0]}${args[1]}.out
conda deactivate
