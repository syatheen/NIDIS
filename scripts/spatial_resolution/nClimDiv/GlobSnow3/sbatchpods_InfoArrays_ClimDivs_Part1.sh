...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/GlobSnow3/Execfile_InfoArrays_ClimDivs_Part1 -n 17
conda deactivate 
exit 0
