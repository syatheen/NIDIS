...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/BlendedVHP/Execfile_InfoArrays_ClimDivsSplit_1Of6 -n 14
conda deactivate 
exit 0
