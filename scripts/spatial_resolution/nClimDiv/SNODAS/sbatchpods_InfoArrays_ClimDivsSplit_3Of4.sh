...
#which python
/usr/local/other/PoDS/PoDS/pods.py -x /discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/SNODAS_later/Execfile_InfoArrays_ClimDivsSplit_3Of4 -n 14
conda deactivate 
exit 0
