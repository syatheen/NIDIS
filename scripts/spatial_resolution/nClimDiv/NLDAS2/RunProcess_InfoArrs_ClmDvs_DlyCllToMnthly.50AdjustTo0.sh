...
#which python
python InfoArrays_ClimDivs_DailyCollToMonthly_50AdjustTo0.py ${args[0]} ${args[1]} ${args[2]} ${args[3]} >& /discover/nobackup/projects/nca/syatheen/NLDAS_2_daily_Outs/InfoArrs_ClmDvs_DlyCllToMnthly_${args[0]}_${args[1]}_${args[2]}${args[3]}_50AdjustTo0.out
conda deactivate
