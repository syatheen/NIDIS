...
GlobSnow3_RefFileName = 'RefArrays/ClimDiv_GlobSnow3_'+format(GlobSnow3_Ref_BeginDateVecList[0],'04')+format(GlobSnow3_Ref_BeginDateVecList[1],'02')+format(GlobSnow3_Ref_BeginDateVecList[2],'02')+'To'+format(GlobSnow3_Ref_EndDateVecList[0],'04')+format(GlobSnow3_Ref_EndDateVecList[1],'02')+format(GlobSnow3_Ref_EndDateVecList[2],'02')+'.npz'
...
for WhichYear in range(GlobSnow3_InfoFiles_BeginYYYYMMDDVecList[0], GlobSnow3_InfoFiles_EndYYYYMMDDVecList[0]+1):
  ...
  for WhichMonth in range(BeginMonth, EndMonth+1):
    ...
    for WhichDoM in range(BeginDoM, EndDoM+1):
      ...
      IfFileExists = os.path.exists(GlobSnow3_InfoFilesDir + 'GlobSnow3_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimDivs.npz')

      if IfFileExists:

        ThisYYYYMMDD_ClimDivs_Info = np.load(GlobSnow3_InfoFilesDir + 'GlobSnow3_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimDivs.npz')
