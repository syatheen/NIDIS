...
#        ThisYear ThisMonth ThisDayOfMonth ThisClimDivsPortion
#ArgNum   1        2         3              4
...
ThisClimDivsPortion = sys.argv[4] # Value is '1st' or '2nd'

ArrayFileName = '/discover/nobackup/projects/nca/syatheen/SNODAS_Npzs/SNODAS_' + format(ThisYear, '04') + format(ThisMonth, '02') + format(ThisDayOfMonth, '02') + '_' + ThisClimDivsPortion + 'ClimDivsPortion.npz'
...
if IfTifFileExists:
  ...
  if ThisClimDivsPortion == '1st':
    outDs = gdal.Translate('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.xyz'.format(BaseFileName), inDs, format='XYZ', creationOptions=["ADD_HEADER_LINE=YES"])
  elif ThisClimDivsPortion == '2nd':
    outDs = gdal.Translate('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_2ndClimDivsPortion.xyz'.format(BaseFileName), inDs, format='XYZ', creationOptions=["ADD_HEADER_LINE=YES"])
  outDs = None
  try:
    if ThisClimDivsPortion == '1st':
      os.remove('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.csv'.format(BaseFileName))
    elif ThisClimDivsPortion == '2nd':
      os.remove('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_2ndClimDivsPortion.csv'.format(BaseFileName))
  except OSError:
    pass
  if ThisClimDivsPortion == '1st':
    os.rename('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.xyz'.format(BaseFileName), '/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.csv'.format(BaseFileName))
  elif ThisClimDivsPortion == '2nd':
    os.rename('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_2ndClimDivsPortion.xyz'.format(BaseFileName), '/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_2ndClimDivsPortion.csv'.format(BaseFileName))
  if ThisClimDivsPortion == '1st':
    GridPoints_XYZ_df = pd.read_csv('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.csv'.format(BaseFileName), sep = ' ', header = 0, dtype = 'float64')
  elif ThisClimDivsPortion == '2nd':
    GridPoints_XYZ_df = pd.read_csv('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_2ndClimDivsPortion.csv'.format(BaseFileName), sep = ' ', header = 0, dtype = 'float64')
  try:
    if ThisClimDivsPortion == '1st':
      os.remove('/discover/nobackup/projects/nca/syatheen/SNODAS/TempCreatedFiles/{}_1stClimDivsPortion.csv'.format(BaseFileName))
    elif ThisClimDivsPortion == '2nd':
  ...
  Valid_GridPoints_XYZ_df = GridPoints_XYZ_df.loc[(GridPoints_XYZ_df.Z >= SNODAS_LowerLimit) & (GridPoints_XYZ_df.Z <= SNODAS_UpperLimit)]
  #Valid_GridPoints_XYZ_df = GridPoints_XYZ_df.loc[(GridPoints_XYZ_df.Z >= SNODAS_LowerLimit)]
...
print("np.amin(np.isnan(InfoArrayForPrcntl).sum(axis=1)) is ",np.amin(np.isnan(InfoArrayForPrcntl).sum(axis=0)))
print("np.amax(np.isnan(InfoArrayForPrcntl).sum(axis=1)) is ",np.amax(np.isnan(InfoArrayForPrcntl).sum(axis=0)))
