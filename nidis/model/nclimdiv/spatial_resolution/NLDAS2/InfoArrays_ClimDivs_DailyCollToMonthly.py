...
ArrayFileName = '/discover/nobackup/projects/nca/syatheen/NLDAS_2_daily_Npzs/' + ArgLSM + '_' + ArgVariable  + '_' + format(ArgYearInt,'04') + format(ArgMonthInt,'02') + '_ClimDivs.PERW.npz'
