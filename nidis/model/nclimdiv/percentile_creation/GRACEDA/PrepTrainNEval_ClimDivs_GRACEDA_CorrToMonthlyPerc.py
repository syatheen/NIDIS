...
TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Train_GRACEDA_Corr2MonthlyPerc_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Dev_GRACEDA_Corr2MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Test_GRACEDA_Corr2MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
...
MonthlyList_GRACEDA_YYYYMMDD_Of_RefArray, MonthlyList_GRACEDA_rtzsm_inst_RefArray = MonthlyList_YYYYMMDDAndArray(GRACEDA_YYYYMMDD_Of_RefArray, GRACEDA_rtzsm_inst_RefArray)
MonthlyList_GRACEDA_YYYYMMDD_Of_RefArray, MonthlyList_GRACEDA_sfsm_inst_RefArray = MonthlyList_YYYYMMDDAndArray(GRACEDA_YYYYMMDD_Of_RefArray, GRACEDA_sfsm_inst_RefArray)
...
MonthlyList_GRACEDA_YYYYMMDD_Of_PrcntlArray, MonthlyList_GRACEDA_rtzsm_inst_PrcntlArray = MonthlyList_YYYYMMDDAndArray(GRACEDA_YYYYMMDD_Of_PrcntlArray, GRACEDA_rtzsm_inst_PrcntlArray)
MonthlyList_GRACEDA_YYYYMMDD_Of_PrcntlArray, MonthlyList_GRACEDA_sfsm_inst_PrcntlArray = MonthlyList_YYYYMMDDAndArray(GRACEDA_YYYYMMDD_Of_PrcntlArray, GRACEDA_sfsm_inst_PrcntlArray)
...
np.savez_compressed(TrainDataFilename, YYYYMMDD_Of_Array = GRACEDA_YYYYMMDD_Of_PrcntlArray, GRACEDA_rtzsm_inst_PrcntlArray = GRACEDA_rtzsm_inst_PrcntlArray, GRACEDA_sfsm_inst_PrcntlArray = GRACEDA_sfsm_inst_PrcntlArray)
...
np.savez_compressed(DevDataFilename, YYYYMMDD_Of_Array = Dev_GRACEDA_YYYYMMDD_Of_PrcntlArray, GRACEDA_rtzsm_inst_PrcntlArray =  Dev_GRACEDA_rtzsm_inst_PrcntlArray, GRACEDA_sfsm_inst_PrcntlArray =  Dev_GRACEDA_sfsm_inst_PrcntlArray)

np.savez_compressed(TestDataFilename, YYYYMMDD_Of_Array = Test_GRACEDA_YYYYMMDD_Of_PrcntlArray, GRACEDA_rtzsm_inst_PrcntlArray =  Test_GRACEDA_rtzsm_inst_PrcntlArray, GRACEDA_sfsm_inst_PrcntlArray =  Test_GRACEDA_sfsm_inst_PrcntlArray)
