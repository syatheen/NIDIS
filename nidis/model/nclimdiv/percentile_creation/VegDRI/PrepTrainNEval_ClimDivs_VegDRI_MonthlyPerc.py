...
VegDRI_RefFileName = 'RefArrays/ClimDiv_VegDRI_20090428To20200804.npz'

TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Train_VegDRI_MonthlyPerc_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Dev_VegDRI_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Test_VegDRI_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
...
MonthlyList_VegDRI_YYYYMMDD_Of_RefArray, MonthlyList_VegDRI_RefArray = MonthlyList_YYYYMMDDAndArray(VegDRI_YYYYMMDD_Of_RefArray, VegDRI_RefArray)
...
VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(VegDRI_YYYYMMDD_Of_RefArray, VegDRI_RefArray, Training_BeginDateVecList, Training_EndDateVecList)

MonthlyList_VegDRI_YYYYMMDD_Of_PrcntlArray, MonthlyList_VegDRI_PrcntlArray = MonthlyList_YYYYMMDDAndArray(VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray)

MonthlyList_VegDRI_PrcntlArray = LoopPrcntlCalcOverMonthsNSpatialUnits(MonthlyList_VegDRI_RefArray, MonthlyList_VegDRI_PrcntlArray)

VegDRI_PrcntlArray = ReAssembleArraysFromMonthlyList(VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray, MonthlyList_VegDRI_YYYYMMDD_Of_PrcntlArray, MonthlyList_VegDRI_PrcntlArray)

print('Training: NumDates = ', VegDRI_PrcntlArray.shape[0], ', NumSpatialUnits = ',VegDRI_PrcntlArray.shape[1])
PrintInfoAboutArray(VegDRI_YYYYMMDD_Of_PrcntlArray, 'VegDRI_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(VegDRI_PrcntlArray, 'VegDRI_PrcntlArray')

np.savez_compressed(TrainDataFilename, YYYYMMDD_Of_Array = VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray = VegDRI_PrcntlArray)

#END section for training

#BEGIN section for evaluation

VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(VegDRI_YYYYMMDD_Of_RefArray, VegDRI_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)
...
Dev_VegDRI_YYYYMMDD_Of_PrcntlArray = VegDRI_YYYYMMDD_Of_PrcntlArray[::2]
Dev_VegDRI_PrcntlArray = VegDRI_PrcntlArray[::2]

Test_VegDRI_YYYYMMDD_Of_PrcntlArray = VegDRI_YYYYMMDD_Of_PrcntlArray[1::2]
Test_VegDRI_PrcntlArray = VegDRI_PrcntlArray[1::2]

print('Evaluation: Dev NumDates = ', Dev_VegDRI_PrcntlArray.shape[0], ', NumSpatialUnits = ', Dev_VegDRI_PrcntlArray.shape[1])
PrintInfoAboutArray(Dev_VegDRI_YYYYMMDD_Of_PrcntlArray, 'Dev_VegDRI_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Dev_VegDRI_PrcntlArray, 'Dev_VegDRI_PrcntlArray')

print('Evaluation: Test NumDates = ', Test_VegDRI_PrcntlArray.shape[0], ', NumSpatialUnits = ', Test_VegDRI_PrcntlArray.shape[1])
PrintInfoAboutArray(Test_VegDRI_YYYYMMDD_Of_PrcntlArray, 'Test_VegDRI_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Test_VegDRI_PrcntlArray, 'Test_VegDRI_PrcntlArray')

np.savez_compressed(DevDataFilename, YYYYMMDD_Of_Array = Dev_VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray = Dev_VegDRI_PrcntlArray)

np.savez_compressed(TestDataFilename, YYYYMMDD_Of_Array = Test_VegDRI_YYYYMMDD_Of_PrcntlArray, VegDRI_PrcntlArray = Test_VegDRI_PrcntlArray)
