...
ESI4Week_RefFileName = 'RefArrays/ClimDiv_ESI4Week_20000104To20200526.npz'
ESI12Week_RefFileName = 'RefArrays/ClimDiv_ESI12Week_20000104To20200526.npz'

TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Train_ESImultiWeek_MonthlyPerc_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Dev_ESImultiWeek_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Test_ESImultiWeek_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
...
ESI4Week_RefObject = np.load(ESI4Week_RefFileName)
ESI12Week_RefObject = np.load(ESI12Week_RefFileName)

ESI4Week_YYYYMMDD_Of_RefArray = ESI4Week_RefObject['ESI4Week_YYYYMMDD_Of_RefArray']
ESI12Week_YYYYMMDD_Of_RefArray = ESI12Week_RefObject['ESI12Week_YYYYMMDD_Of_RefArray']
...
MonthlyList_ESI4Week_YYYYMMDD_Of_RefArray, MonthlyList_ESI4Week_RefArray = MonthlyList_YYYYMMDDAndArray(ESI4Week_YYYYMMDD_Of_RefArray, ESI4Week_RefArray)
MonthlyList_ESI12Week_YYYYMMDD_Of_RefArray, MonthlyList_ESI12Week_RefArray = MonthlyList_YYYYMMDDAndArray(ESI12Week_YYYYMMDD_Of_RefArray, ESI12Week_RefArray)
...
ESI4Week_YYYYMMDD_Of_PrcntlArray, ESI4Week_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(ESI4Week_YYYYMMDD_Of_RefArray, ESI4Week_RefArray, Training_BeginDateVecList, Training_EndDateVecList)
ESI12Week_YYYYMMDD_Of_PrcntlArray, ESI12Week_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(ESI12Week_YYYYMMDD_Of_RefArray, ESI12Week_RefArray, Training_BeginDateVecList, Training_EndDateVecList)

MonthlyList_ESI4Week_YYYYMMDD_Of_PrcntlArray, MonthlyList_ESI4Week_PrcntlArray = MonthlyList_YYYYMMDDAndArray(ESI4Week_YYYYMMDD_Of_PrcntlArray, ESI4Week_PrcntlArray)
MonthlyList_ESI12Week_YYYYMMDD_Of_PrcntlArray, MonthlyList_ESI12Week_PrcntlArray = MonthlyList_YYYYMMDDAndArray(ESI12Week_YYYYMMDD_Of_PrcntlArray, ESI12Week_PrcntlArray)

MonthlyList_ESI4Week_PrcntlArray = LoopPrcntlCalcOverMonthsNSpatialUnits(MonthlyList_ESI4Week_RefArray, MonthlyList_ESI4Week_PrcntlArray)
MonthlyList_ESI12Week_PrcntlArray = LoopPrcntlCalcOverMonthsNSpatialUnits(MonthlyList_ESI12Week_RefArray, MonthlyList_ESI12Week_PrcntlArray)

ESI4Week_PrcntlArray = ReAssembleArraysFromMonthlyList(ESI4Week_YYYYMMDD_Of_PrcntlArray, ESI4Week_PrcntlArray, MonthlyList_ESI4Week_YYYYMMDD_Of_PrcntlArray, MonthlyList_ESI4Week_PrcntlArray)
ESI12Week_PrcntlArray = ReAssembleArraysFromMonthlyList(ESI12Week_YYYYMMDD_Of_PrcntlArray, ESI12Week_PrcntlArray, MonthlyList_ESI12Week_YYYYMMDD_Of_PrcntlArray, MonthlyList_ESI12Week_PrcntlArray)

print('Training: NumDates = ', ESI4Week_PrcntlArray.shape[0], ', NumSpatialUnits = ',ESI4Week_PrcntlArray.shape[1])
PrintInfoAboutArray(ESI4Week_YYYYMMDD_Of_PrcntlArray, 'ESI4Week_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(ESI4Week_PrcntlArray, 'ESI4Week_PrcntlArray')
PrintInfoAboutArray(ESI12Week_PrcntlArray, 'ESI12Week_PrcntlArray')

np.savez_compressed(TrainDataFilename, 
                    YYYYMMDD_Of_Array = ESI4Week_YYYYMMDD_Of_PrcntlArray, 
                    ESI4Week_PrcntlArray = ESI4Week_PrcntlArray,
                    ESI12Week_PrcntlArray = ESI12Week_PrcntlArray)

#END section for training

#BEGIN section for evaluation

ESI4Week_YYYYMMDD_Of_PrcntlArray, ESI4Week_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(ESI4Week_YYYYMMDD_Of_RefArray, ESI4Week_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)
ESI12Week_YYYYMMDD_Of_PrcntlArray, ESI12Week_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(ESI12Week_YYYYMMDD_Of_RefArray, ESI12Week_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)
...
Dev_ESI4Week_YYYYMMDD_Of_PrcntlArray = ESI4Week_YYYYMMDD_Of_PrcntlArray[::2]
Dev_ESI12Week_YYYYMMDD_Of_PrcntlArray = ESI12Week_YYYYMMDD_Of_PrcntlArray[::2]

Dev_ESI4Week_PrcntlArray = ESI4Week_PrcntlArray[::2]
Dev_ESI12Week_PrcntlArray = ESI12Week_PrcntlArray[::2]

Test_ESI4Week_YYYYMMDD_Of_PrcntlArray = ESI4Week_YYYYMMDD_Of_PrcntlArray[1::2]
Test_ESI12Week_YYYYMMDD_Of_PrcntlArray = ESI12Week_YYYYMMDD_Of_PrcntlArray[1::2]

Test_ESI4Week_PrcntlArray = ESI4Week_PrcntlArray[1::2]
Test_ESI12Week_PrcntlArray = ESI12Week_PrcntlArray[1::2]

print('Evaluation: Dev NumDates = ', Dev_ESI4Week_PrcntlArray.shape[0], ', NumSpatialUnits = ', Dev_ESI4Week_PrcntlArray.shape[1])
PrintInfoAboutArray(Dev_ESI4Week_YYYYMMDD_Of_PrcntlArray, 'Dev_ESI4Week_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Dev_ESI4Week_PrcntlArray, 'Dev_ESI4Week_PrcntlArray')
PrintInfoAboutArray(Dev_ESI12Week_PrcntlArray, 'Dev_ESI12Week_PrcntlArray')

print('Evaluation: Test NumDates = ', Test_ESI4Week_PrcntlArray.shape[0], ', NumSpatialUnits = ', Test_ESI4Week_PrcntlArray.shape[1])
PrintInfoAboutArray(Test_ESI4Week_YYYYMMDD_Of_PrcntlArray, 'Test_ESI4Week_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Test_ESI4Week_PrcntlArray, 'Test_ESI4Week_PrcntlArray')
PrintInfoAboutArray(Test_ESI12Week_PrcntlArray, 'Test_ESI12Week_PrcntlArray')

np.savez_compressed(DevDataFilename, 
                    YYYYMMDD_Of_Array = Dev_ESI4Week_YYYYMMDD_Of_PrcntlArray, 
                    ESI4Week_PrcntlArray = Dev_ESI4Week_PrcntlArray,
                    ESI12Week_PrcntlArray = Dev_ESI12Week_PrcntlArray)

np.savez_compressed(TestDataFilename, 
                    YYYYMMDD_Of_Array = Test_ESI4Week_YYYYMMDD_Of_PrcntlArray, 
                    ESI4Week_PrcntlArray = Test_ESI4Week_PrcntlArray,
                    ESI12Week_PrcntlArray = Test_ESI12Week_PrcntlArray)
