...
QuickDRI_RefFileName = 'RefArrays/ClimDiv_QuickDRI_20000125To20201229.npz'

TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Train_QuickDRI_MonthlyPerc_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Dev_QuickDRI_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Test_QuickDRI_MonthlyPerc_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
...
QuickDRI_YYYYMMDD_Of_PrcntlArray, QuickDRI_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(QuickDRI_YYYYMMDD_Of_RefArray, QuickDRI_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)
...
Dev_QuickDRI_YYYYMMDD_Of_PrcntlArray = QuickDRI_YYYYMMDD_Of_PrcntlArray[::2]
Dev_QuickDRI_PrcntlArray = QuickDRI_PrcntlArray[::2]

Test_QuickDRI_YYYYMMDD_Of_PrcntlArray = QuickDRI_YYYYMMDD_Of_PrcntlArray[1::2]
Test_QuickDRI_PrcntlArray = QuickDRI_PrcntlArray[1::2]

print('Evaluation: Dev NumDates = ', Dev_QuickDRI_PrcntlArray.shape[0], ', NumSpatialUnits = ', Dev_QuickDRI_PrcntlArray.shape[1])
PrintInfoAboutArray(Dev_QuickDRI_YYYYMMDD_Of_PrcntlArray, 'Dev_QuickDRI_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Dev_QuickDRI_PrcntlArray, 'Dev_QuickDRI_PrcntlArray')

print('Evaluation: Test NumDates = ', Test_QuickDRI_PrcntlArray.shape[0], ', NumSpatialUnits = ', Test_QuickDRI_PrcntlArray.shape[1])
PrintInfoAboutArray(Test_QuickDRI_YYYYMMDD_Of_PrcntlArray, 'Test_QuickDRI_YYYYMMDD_Of_PrcntlArray')
PrintInfoAboutArray(Test_QuickDRI_PrcntlArray, 'Test_QuickDRI_PrcntlArray')

np.savez_compressed(DevDataFilename, YYYYMMDD_Of_Array = Dev_QuickDRI_YYYYMMDD_Of_PrcntlArray, QuickDRI_PrcntlArray = Dev_QuickDRI_PrcntlArray)

np.savez_compressed(TestDataFilename, YYYYMMDD_Of_Array = Test_QuickDRI_YYYYMMDD_Of_PrcntlArray, QuickDRI_PrcntlArray = Test_QuickDRI_PrcntlArray)
