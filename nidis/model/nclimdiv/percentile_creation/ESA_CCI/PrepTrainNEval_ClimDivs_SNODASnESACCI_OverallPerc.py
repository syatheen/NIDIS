...
SNODAS_RefFileName = 'RefArrays/ClimDiv_SNODAS_20030930To20201229.npz'
ESA_CCI_RefFileName = 'RefArrays/ClimDiv_ESA_CCI_19781107To20201229.npz'

TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Train_SNODASnESACCI_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Dev_SNODASnESACCI_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/ClimDivs/Test_SNODASnESACCI_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
...
SNODAS_YYYYMMDD_Of_PrcntlArray, SNODAS_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(SNODAS_YYYYMMDD_Of_RefArray, SNODAS_RefArray, Training_BeginDateVecList, Training_EndDateVecList)
...
np.savez_compressed(TrainDataFilename, YYYYMMDD_Of_Array = SNODAS_YYYYMMDD_Of_PrcntlArray, SNODAS_PrcntlArray = SNODAS_PrcntlArray, ESA_CCI_PrcntlArray = ESA_CCI_PrcntlArray)

#END section for training

#BEGIN section for evaluation

SNODAS_YYYYMMDD_Of_PrcntlArray, SNODAS_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(SNODAS_YYYYMMDD_Of_RefArray, SNODAS_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)
ESA_CCI_YYYYMMDD_Of_PrcntlArray, ESA_CCI_PrcntlArray = TimeSlice_YYYYMMDDAndRefArray(ESA_CCI_YYYYMMDD_Of_RefArray, ESA_CCI_RefArray, Eval_BeginDateVecList, Eval_EndDateVecList)

SNODAS_PrcntlArray = LoopPercentileCalcOverSpatialUnits(SNODAS_RefArray, SNODAS_PrcntlArray)
ESA_CCI_PrcntlArray = LoopPercentileCalcOverSpatialUnits(ESA_CCI_RefArray, ESA_CCI_PrcntlArray)

Dev_SNODAS_YYYYMMDD_Of_PrcntlArray = SNODAS_YYYYMMDD_Of_PrcntlArray[::2]

Dev_SNODAS_PrcntlArray = SNODAS_PrcntlArray[::2]
Dev_ESA_CCI_PrcntlArray = ESA_CCI_PrcntlArray[::2]

Test_SNODAS_YYYYMMDD_Of_PrcntlArray = SNODAS_YYYYMMDD_Of_PrcntlArray[1::2]

Test_SNODAS_PrcntlArray = SNODAS_PrcntlArray[1::2]
Test_ESA_CCI_PrcntlArray = ESA_CCI_PrcntlArray[1::2]

print('Evaluation: Dev NumDates = ', Dev_SNODAS_PrcntlArray.shape[0], ', NumSpatialUnits = ', Dev_SNODAS_PrcntlArray.shape[1])
PrintInfoAboutArray(Dev_SNODAS_PrcntlArray, 'Dev_SNODAS_PrcntlArray')
PrintInfoAboutArray(Dev_ESA_CCI_PrcntlArray, 'Dev_ESA_CCI_PrcntlArray')

print('Evaluation: Test NumDates = ', Test_SNODAS_PrcntlArray.shape[0], ', NumSpatialUnits = ', Test_SNODAS_PrcntlArray.shape[1])
PrintInfoAboutArray(Test_SNODAS_PrcntlArray, 'Test_SNODAS_PrcntlArray')
PrintInfoAboutArray(Test_ESA_CCI_PrcntlArray, 'Test_ESA_CCI_PrcntlArray')

np.savez_compressed(DevDataFilename, YYYYMMDD_Of_Array = Dev_SNODAS_YYYYMMDD_Of_PrcntlArray, SNODAS_PrcntlArray = Dev_SNODAS_PrcntlArray, ESA_CCI_PrcntlArray = Dev_ESA_CCI_PrcntlArray)

np.savez_compressed(TestDataFilename, YYYYMMDD_Of_Array = Test_SNODAS_YYYYMMDD_Of_PrcntlArray, SNODAS_PrcntlArray = Test_SNODAS_PrcntlArray, ESA_CCI_PrcntlArray = Test_ESA_CCI_PrcntlArray)
