...
OutFilePath = 'InfoArrsNMonthsMean/ClimDivs/'
...
for WhichYear in range(BeginYear, EndYear+1):
  ...
  for WhichMonth in range(BeginMonth_ThisYear, EndMonth_ThisYear+1):
    ...
    InfoArrayFile_Info = np.load('/discover/nobackup/projects/nca/syatheen/nClimGrid_Npzs/' + VariabStr + '_' + format(WhichYear,'04') + format(WhichMonth,'02') + 'ClimDivs.npz')
