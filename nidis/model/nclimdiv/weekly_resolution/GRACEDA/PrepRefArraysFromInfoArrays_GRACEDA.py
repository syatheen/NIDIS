...
GRACEDA_InfoFilesDir = '/att/nobackup/syatheen/Data/ML_Testcases/Drought_USDM/GRACE/RefPctlArrsWeekly/'

GRACEDA_WhichVariable = 'gws_inst' # choices are gws_inst, rtzsm_inst and sfsm_inst
...
GRACEDA_RefFileName = 'RefArrays/ClimDiv_GRACEDA_'+GRACEDA_WhichVariable+'_'+format(GRACEDA_Ref_BeginDateVecList[0],'04')+format(GRACEDA_Ref_BeginDateVecList[1],'02')+format(GRACEDA_Ref_BeginDateVecList[2],'02')+'To'+format(GRACEDA_Ref_EndDateVecList[0],'04')+format(GRACEDA_Ref_EndDateVecList[1],'02')+format(GRACEDA_Ref_EndDateVecList[2],'02')+'.npz'
...
for ThisYear in range(GRACEDA_InfoFiles_BeginYear, GRACEDA_InfoFiles_EndYear+1, 1):
  ThisYear_GRACEDA_Info = np.load(GRACEDA_InfoFilesDir+format(ThisYear, '04')+'_'+GRACEDA_WhichVariable+'.npz')  
  ThisYear_GRACEDA_YYYYMMDD_Of_InfoArray = ThisYear_GRACEDA_Info['YYYYMMDD_Of_RefPrcntlArray']
  ThisYear_GRACEDA_InfoArray  = ThisYear_GRACEDA_Info['RefPrcntlArray']
