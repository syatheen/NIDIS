...
VegDRI_InfoFilesDir = '/att/nobackup/syatheen/Data/ML_Testcases/Drought_USDM/VegDRI/RefArrsWeekly/'
...
VegDRI_RefFileName = 'RefArrays/ClimDiv_VegDRI_'+format(VegDRI_Ref_BeginDateVecList[0],'04')+format(VegDRI_Ref_BeginDateVecList[1],'02')+format(VegDRI_Ref_BeginDateVecList[2],'02')+'To'+format(VegDRI_Ref_EndDateVecList[0],'04')+format(VegDRI_Ref_EndDateVecList[1],'02')+format(VegDRI_Ref_EndDateVecList[2],'02')+'.npz'
...
for ThisWeek in range(NumWeeks):
  ...
  InfoArrayFileName = VegDRI_InfoFilesDir+format(ThisYear,'04')+format(ThisMonth,'02')+format(ThisDoM,'02')+'.npz'
