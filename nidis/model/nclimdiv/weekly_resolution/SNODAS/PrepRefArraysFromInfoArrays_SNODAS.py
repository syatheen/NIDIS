...
SNODAS_InfoFiles_BeginYYYYMMDDVecList = [2003, 9, 30] 
SNODAS_InfoFiles_EndYYYYMMDDVecList = [2020, 12, 31] 

SNODAS_Ref_BeginDateVecList = [2003, 9, 30]  # SNODAS beginning year, month, day of month, this is also a Tuesday
SNODAS_Ref_EndDateVecList = [2020, 12, 29]  # SNODAS ending year, month, day of month, this is also a Tuesday

SNODAS_RefFileName = 'RefArrays/ClimDiv_SNODAS_'+format(SNODAS_Ref_BeginDateVecList[0],'04')+format(SNODAS_Ref_BeginDateVecList[1],'02')+format(SNODAS_Ref_BeginDateVecList[2],'02')+'To'+format(SNODAS_Ref_EndDateVecList[0],'04')+format(SNODAS_Ref_EndDateVecList[1],'02')+format(SNODAS_Ref_EndDateVecList[2],'02')+'.npz'
...
for WhichYear in range(SNODAS_InfoFiles_BeginYYYYMMDDVecList[0], SNODAS_InfoFiles_EndYYYYMMDDVecList[0]+1):
  ...
  for WhichMonth in range(BeginMonth, EndMonth+1):
    ...
    for WhichDoM in range(BeginDoM, EndDoM+1):
      ...
      If1stFileExists = os.path.exists(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_1stClimDivsPortion.npz')
      If2ndFileExists = os.path.exists(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_2ndClimDivsPortion.npz')

      if (If1stFileExists and If2ndFileExists):

        ThisYYYYMMDD_1stClimDivsSplit_Info = np.load(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_1stClimDivsPortion.npz')
        ThisYYYYMMDD_2ndClimDivsSplit_Info = np.load(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_2ndClimDivsPortion.npz')
...
SNODAS_RealDatesList_Of_InfoArray = GetRealDatesListOfInfoArray(SNODAS_YYYYMMDD_Of_InfoArray, 3, 'SNODAS', np.NaN)
...
np.savez_compressed(SNODAS_RefFileName, SNODAS_RefArray = SNODAS_RefArray, SNODAS_YYYYMMDD_Of_RefArray = SNODAS_YYYYMMDD_Of_RefArray)
