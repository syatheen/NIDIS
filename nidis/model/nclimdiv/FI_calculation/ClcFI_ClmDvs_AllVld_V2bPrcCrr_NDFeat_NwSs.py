...
os.makedirs("/discover/nobackup/syatheen/Sujay/DeepLearning/ExampleTries/NIDIS/FI_ClmDvs_AllVld_V2bPrcCrr_New/" + NumInpsForNDFracMI, exist_ok=True)

#FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_ClmDvs_AllVld_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/' + IfMakeTargetBinary + IfIncludeD0AsDrought + '_' + WhichTrainData_ShortStr + '_' + TargetVariable_ShortStr + '_' + SpatialDomain_ShortStr 
#if IfSpatialSubDomain:
...
FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_ClmDvs_AllVld_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/ClimDivs_' + SpatialDomain   
if NumInpLayers >= 0:
  FracI_ClimDivs_AllValid_NDFeat_FileName = FracI_ClimDivs_AllValid_NDFeat_FileName + '_All' + str(NumInpLayers) + 'Valid' 
elif NumInpLayers < 0:
  FracI_ClimDivs_AllValid_NDFeat_FileName = FracI_ClimDivs_AllValid_NDFeat_FileName + '_' + InpsString + 'Valid' 
#end of if NumInpLayers >= 0
...
#      SPI24_PrcntlArray = SPI24_PrcntlArray[WhichRows[0], :]
  ...
  #    Inputs_Mat = np.concatenate( (Inputs_Mat, SPI24_PrcntlArray[:, jCol:jCol+1]), axis = 1)
    ...
    #Target_Array = Target_Array[ ValidRows[0], :] # SY: NOTE Change to following line
    Target_Array_Here = Target_Array[ ValidRows[0], jCol:jCol+1 ] # SY: NOTE Change from previous line
