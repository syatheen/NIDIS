...
if SpatialSubDomain[0:5] == 'Event':
  FracI_ClimDivs_AllValid_NDFeat_FileName = 'FracI_ClimDivs_V2b_New/' + NumInpsForNDFracMI + '/' + IfMakeTargetBinary + IfIncludeD0AsDrought + '_' + TargetVariable_ShortStr + '_' + SpatialDomain_ShortStr 
