...
os.makedirs("/discover/nobackup/syatheen/Sujay/DeepLearning/ExampleTries/NIDIS/FI_USDMRgns_V2bPrcCrr_New/" + NumInpsForNDFracMI, exist_ok=True)
if SpatialSubDomain[0:5] == 'Event':
  FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_USDMRgns_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/' + IfMakeTargetBinary + IfIncludeD0AsDrought + '_' + TargetVariable_ShortStr + '_' + SpatialDomain_ShortStr 
else: # if SpatialSubDomain[0:5] == 'Event'
  FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_USDMRgns_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/' + IfMakeTargetBinary + IfIncludeD0AsDrought + '_' + WhichTrainData_ShortStr + '_' + TargetVariable_ShortStr + '_' + SpatialDomain_ShortStr 
