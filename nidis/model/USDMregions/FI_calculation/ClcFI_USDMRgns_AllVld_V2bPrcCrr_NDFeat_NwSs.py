...
os.makedirs("/discover/nobackup/syatheen/Sujay/DeepLearning/ExampleTries/NIDIS/FI_USDMRgns_AllVld_V2bPrcCrr_New/" + NumInpsForNDFracMI, exist_ok=True)

#FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_USDMRgns_AllVld_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/' + IfMakeTargetBinary + IfIncludeD0AsDrought + '_' + WhichTrainData_ShortStr + '_' + TargetVariable_ShortStr + '_' + SpatialDomain_ShortStr 
#if IfSpatialSubDomain:
...
FracI_ClimDivs_AllValid_NDFeat_FileName = 'FI_USDMRgns_AllVld_V2bPrcCrr_New/' + NumInpsForNDFracMI + '/USDMregion_' + SpatialDomain
if NumInpLayers >= 0:
...
def GetInpAndTargArraysFromFile(XYDatas, InpLayersCombination, IfSpatialSubDomain, WhichCols, IfMakeTargetBinary, IfIncludeD0AsDrought, WhichSeason):
...
#end of def GetInpAndTargArraysFromFile(XYDatas, InpLayersCombination, IfSpatialSubDomain, WhichCols, IfMakeTargetBinary, IfIncludeD0AsDrought, WhichSeason):

Train_Target_Array, Train_Inputs_Mat = GetInpAndTargArraysFromFile(TrainDatas, InpLayersCombination, IfSpatialSubDomain, WhichCols, IfMakeTargetBinary, IfIncludeD0AsDrought, WhichSeason)
Dev_Target_Array, Dev_Inputs_Mat = GetInpAndTargArraysFromFile(DevDatas, InpLayersCombination, IfSpatialSubDomain, WhichCols, IfMakeTargetBinary, IfIncludeD0AsDrought, WhichSeason)
Test_Target_Array, Test_Inputs_Mat = GetInpAndTargArraysFromFile(TestDatas, InpLayersCombination, IfSpatialSubDomain, WhichCols, IfMakeTargetBinary, IfIncludeD0AsDrought, WhichSeason)
...
column_names = copy.deepcopy([SpatialDomain])
