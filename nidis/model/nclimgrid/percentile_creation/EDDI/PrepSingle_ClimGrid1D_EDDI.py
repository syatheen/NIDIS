...
EDDI_RefFileName = '/discover/nobackup/projects/nca/syatheen/EDDI_Npzs/RefArrays/ClimGrid1D_EDDI_'+EDDI_WhichPastPeriod+'_19800108To20220412.npz'

SingleUnifiedDataFilename = 'PreppedTrainNEvalNpzs/ClimGrid1D/SingleUnified_EDDI'+EDDI_WhichPastPeriod+'_'+str(SingleUnified_BeginDateVecList[0])+format(SingleUnified_BeginDateVecList[1],'02')+format(SingleUnified_BeginDateVecList[2],'02')+'To'+str(SingleUnified_EndDateVecList[0])+format(SingleUnified_EndDateVecList[1],'02')+format(SingleUnified_EndDateVecList[2],'02')+'.npz'
