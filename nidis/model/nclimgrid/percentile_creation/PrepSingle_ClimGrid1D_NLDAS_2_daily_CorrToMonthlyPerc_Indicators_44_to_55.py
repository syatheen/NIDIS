...
def main(ArgLSM='Mosaic', ArgVariable='EVAP', ArgHUC='NA'):
  ...
  if (ArgVariable == 'STRM') :
    ...
    SingleUnifiedDataFilename = os.path.join(
      ...
      'SingleUnified_NLDAS_2_dly_' + ArgLSM + '_' + ArgVariable + '_' + ArgHUC + '_Crr2MnthlyPrc_' + str(SingleUnified_BeginDateVecList[0]) + format(SingleUnified_BeginDateVecList[1],'02') + format(SingleUnified_BeginDateVecList[2],'02') + 'To' + str(SingleUnified_EndDateVecList[0]) + format(SingleUnified_EndDateVecList[1],'02') + format(SingleUnified_EndDateVecList[2],'02') + '.npz'
    )
    ...
    SingleUnifiedDataFilename = os.path.join(
      output_path_percentile,
      'SingleUnified_NLDAS_2_dly_' + ArgLSM + '_' + ArgVariable + '_Crr2MnthlyPrc_' + str(SingleUnified_BeginDateVecList[0]) + format(SingleUnified_BeginDateVecList[1],'02') + format(SingleUnified_BeginDateVecList[2],'02') + 'To' + str(SingleUnified_EndDateVecList[0]) + format(SingleUnified_EndDateVecList[1],'02') + format(SingleUnified_EndDateVecList[2],'02') + '.npz'
    )
