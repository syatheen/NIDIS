...
-> PrepTrainNEval_ClimGrid_Indicators_3_to_4.py : 3: 'PMDI',
                                                  4: 'PHDI' 
     Note that this PrepTrainNEval_ClimGrid_Indicators_3_to_4.py file is the initial code structure, have to convert this to final structure.

-> NCEI/PrepSingle_ClimGrid1D_nClimGrid.py :   5: 'prcp_01_nCG',
                                               6: 'prcp_02_nCG',
                                               7: 'prcp_03_nCG',
                                               8: 'prcp_06_nCG',
                                               9: 'prcp_09_nCG',
...
-> EDDI/PrepSingle_ClimGrid1D_EDDI_CorrToMonthlyPerc.py :   20: 'EDDI_1wk',
                                                            21: 'EDDI_2wk',
                                                            22: 'EDDI_3wk',
                                                            23: 'EDDI_4wk',
                                                            24: 'EDDI_5wk',
                                                            ...
                                                            41: 'EDDI_10mn',
                                                            42: 'EDDI_11mn',
-> EDDI/PrepSingle_ClimGrid1D_EDDI.py :                     43: 'EDDI_12mn'
     Note that these EDDI files is the initial code structure, I have to change this to final structure.

-> PrepSingle_ClimGrid1D_NLDAS_2_daily_CorrToMonthlyPerc_Indicators_44_to_55.py :    44: 'NLDAS2D_1MSM_Mosaic',
                                                                                     ...
                                                                                     54: 'NLDAS2D_EVAP_SAC',
                                                                                     55: 'NLDAS2D_EVAP_VIC',
-> PrepSingle_ClimGrid1D_NLDAS_2_daily_Indicators_56_to_67.py : 56: 'NLDAS2D_SWE_Mosaic',
                                                                57: 'NLDAS2D_SWE_Noah',
                                                                58: 'NLDAS2D_SWE_SAC',
                                                                59: 'NLDAS2D_SWE_VIC',
...
-> SNODAS/PrepSingle_ClimGrid1D_SNODAS_OverallPerc.py  : 96: 'SNODAS'
     Note that this SNODAS/PrepSingle_ClimGrid1D_SNODAS_OverallPerc.py is the initial code structure, have to change this to final structure.
