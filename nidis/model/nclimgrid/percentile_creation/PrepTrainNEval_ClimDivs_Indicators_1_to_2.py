...
ZIndex_RefFileName = 'RefArrays/ClimDiv_ZIndex_19320119To20191231.npz'
ZIndex60month_RefFileName = 'RefArrays/ClimDiv_ZIndex60month_19320119To20191231.npz'
...
Pcpn1month_RefFileName = 'RefArrays/ClimDiv_Pcpn1month_19320202To20191231.npz'
Pcpn3month_RefFileName = 'RefArrays/ClimDiv_Pcpn3month_19320202To20191231.npz'
Pcpn6month_RefFileName = 'RefArrays/ClimDiv_Pcpn6month_19320202To20191231.npz'
...
CPCsoilmoist_RefFileName = 'RefArrays/ClimDiv_CPCsoilmoist_20080205To20191231.npz'
...
TrainDataFilename = 'PreppedTrainNEvalNpzs/Train_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'

DevDataFilename = 'PreppedTrainNEvalNpzs/Dev_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
TestDataFilename = 'PreppedTrainNEvalNpzs/Test_'+str(Eval_BeginDateVecList[0])+format(Eval_BeginDateVecList[1],'02')+format(Eval_BeginDateVecList[2],'02')+'To'+str(Eval_EndDateVecList[0])+format(Eval_EndDateVecList[1],'02')+format(Eval_EndDateVecList[2],'02')+'.npz'
