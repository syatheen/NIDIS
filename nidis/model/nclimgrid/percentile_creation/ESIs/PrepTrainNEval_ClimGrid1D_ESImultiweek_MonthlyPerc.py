...
ESI4Week_RefFileName = 'RefArrays/ClimGrid1D_ESI4Week_20000104To20200526.npz'
ESI12Week_RefFileName = 'RefArrays/ClimGrid1D_ESI12Week_20000104To20200526.npz'

TrainDataFilename = 'PreppedTrainNEvalNpzs/ClimGrid1D/SingleUnified_ESImultiWeek_MonthlyPerc_'+str(Training_BeginDateVecList[0])+format(Training_BeginDateVecList[1],'02')+format(Training_BeginDateVecList[2],'02')+'To'+str(Training_EndDateVecList[0])+format(Training_EndDateVecList[1],'02')+format(Training_EndDateVecList[2],'02')+'.npz'
