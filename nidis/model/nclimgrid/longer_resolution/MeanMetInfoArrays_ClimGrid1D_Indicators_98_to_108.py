...
OutFilePath = 'InfoArrsDailyMean/ClimGrid1D/'
...
for WhichYear in range(BeginYYYYMM[0], EndYYYYMM[0]+1):
  ...
  for WhichMonth in range(BeginMonth, EndMonth+1):
    ...
    InfoArrayFile_Info = np.load('/discover/nobackup/projects/nca/syatheen/IMERG_Npzs/daily_Final_V06/IMERG_' + format(WhichYear,'04') + format(WhichMonth,'02') + '_ClimGrid1D.npz')
