...
ESI4Week_InfoFilename = '/discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/ESI/InfoArrsDailyToMean/ClimGrid1D/ESI4WeeksMean_20000101To20200530.npz'
ESI12Week_InfoFilename = '/discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/ESI/InfoArrsDailyToMean/ClimGrid1D/ESI12WeeksMean_20000101To20200530.npz'
...
ESI4Week_RefFileName = 'RefArrays/ClimGrid1D_ESI4Week_'+format(ESI4Week_Ref_BeginDateVecList[0],'04')+format(ESI4Week_Ref_BeginDateVecList[1],'02')+format(ESI4Week_Ref_BeginDateVecList[2],'02')+'To'+format(ESI4Week_Ref_EndDateVecList[0],'04')+format(ESI4Week_Ref_EndDateVecList[1],'02')+format(ESI4Week_Ref_EndDateVecList[2],'02')+'.npz'
ESI12Week_RefFileName = 'RefArrays/ClimGrid1D_ESI12Week_'+format(ESI12Week_Ref_BeginDateVecList[0],'04')+format(ESI12Week_Ref_BeginDateVecList[1],'02')+format(ESI12Week_Ref_BeginDateVecList[2],'02')+'To'+format(ESI12Week_Ref_EndDateVecList[0],'04')+format(ESI12Week_Ref_EndDateVecList[1],'02')+format(ESI12Week_Ref_EndDateVecList[2],'02')+'.npz'
