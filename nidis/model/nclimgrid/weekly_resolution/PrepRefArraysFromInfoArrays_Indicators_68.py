...
def main():
  ...
  SNODAS_InfoFilesDir = '/discover/nobackup/syatheen/Sujay/DeepLearning/Data/ML_Testcases/Drought_USDM/VegDRI/RefArrsWeekly/'

  SNODAS_InfoFiles_BeginYYYYMMDDVecList = [2009, 4, 26] 
  SNODAS_InfoFiles_EndYYYYMMDDVecList = [2020, 8, 9] 

  SNODAS_Ref_BeginDateVecList = [2009, 4, 28]  # SNODAS beginning year, month, day of month, this is also a Tuesday
  SNODAS_Ref_EndDateVecList = [2020, 8, 4]  # SNODAS ending year, month, day of month, this is also a Tuesday

  SNODAS_RefFileName = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/Indicator_68/RefArrays/ClimGrid1D_VegDRI_'+format(SNODAS_Ref_BeginDateVecList[0],'04')+format(SNODAS_Ref_BeginDateVecList[1],'02')+format(SNODAS_Ref_BeginDateVecList[2],'02')+'To'+format(SNODAS_Ref_EndDateVecList[0],'04')+format(SNODAS_Ref_EndDateVecList[1],'02')+format(SNODAS_Ref_EndDateVecList[2],'02')+'.npz'
  ...
  SNODAS_RealDatesList_Of_InfoArray = GetRealDatesListOfInfoArray(SNODAS_YYYYMMDD_Of_InfoArray, 3, 'VegDRI', np.NaN)
  ...
  np.savez_compressed(SNODAS_RefFileName, 
                      VegDRI_RefArray = SNODAS_RefArray, 
                      VegDRI_YYYYMMDD_Of_RefArray = SNODAS_YYYYMMDD_Of_RefArray)
