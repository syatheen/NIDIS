...
SNODAS_RefFileName = 'RefArrays/ClimGrid1D_SNODAS_'+format(SNODAS_Ref_BeginDateVecList[0],'04')+format(SNODAS_Ref_BeginDateVecList[1],'02')+format(SNODAS_Ref_BeginDateVecList[2],'02')+'To'+format(SNODAS_Ref_EndDateVecList[0],'04')+format(SNODAS_Ref_EndDateVecList[1],'02')+format(SNODAS_Ref_EndDateVecList[2],'02')+'.npz'
...
for WhichYear in range(SNODAS_InfoFiles_BeginYYYYMMDDVecList[0], SNODAS_InfoFiles_EndYYYYMMDDVecList[0]+1):
  ...
  for WhichMonth in range(BeginMonth, EndMonth+1):
    ...
    for WhichDoM in range(BeginDoM, EndDoM+1):
      ...
      IfFileExists = os.path.exists(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimGrid1D.npz')

      if IfFileExists:

        ThisYYYYMMDD_ClimGrid1D_Info = np.load(SNODAS_InfoFilesDir + 'SNODAS_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimGrid1D.npz')
  
        ThisYYYYMMDD_Of_InfoArrayForPrcntl = ThisYYYYMMDD_ClimGrid1D_Info['YYYYMMDD_Of_InfoArrayForPrcntl']
        ThisYYYYMMDD_InfoArray = ThisYYYYMMDD_ClimGrid1D_Info['InfoArrayForPrcntl'] 
...
np.savez_compressed(SNODAS_RefFileName, 
                    SNODAS_RefArray = SNODAS_RefArray, 
                    SNODAS_YYYYMMDD_Of_RefArray = SNODAS_YYYYMMDD_Of_RefArray)
