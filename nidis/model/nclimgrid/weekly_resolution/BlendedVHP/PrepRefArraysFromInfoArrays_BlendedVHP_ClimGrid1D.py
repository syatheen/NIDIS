...
WhichVariable = sys.argv[1] # Choices are 'SMN', 'TCI', 'VCI' and 'VHI'
...
BlendedVHP_RefFileName = 'RefArrays/ClimGrid1D_BlendedVHP_'+WhichVariable+'_'+format(BlendedVHP_Ref_BeginDateVecList[0],'04')+format(BlendedVHP_Ref_BeginDateVecList[1],'02')+format(BlendedVHP_Ref_BeginDateVecList[2],'02')+'To'+format(BlendedVHP_Ref_EndDateVecList[0],'04')+format(BlendedVHP_Ref_EndDateVecList[1],'02')+format(BlendedVHP_Ref_EndDateVecList[2],'02')+'.npz'
...
for WhichYear in range(BlendedVHP_InfoFiles_BeginYearWeekVecList[0], BlendedVHP_InfoFiles_EndYearWeekVecList[0]+1):
  ...
  for WhichWeek in range(BeginWeek, EndWeek+1):
    ...
    IfFileExists = os.path.exists(BlendedVHP_InfoFilesDir + FileNameStartStr + '_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimGrid1D.npz')

    if IfFileExists:

      ThisYYYYMMDD_ClimGrid1D_Info = np.load(BlendedVHP_InfoFilesDir + FileNameStartStr + '_' + format(WhichYear, '04') + format(WhichMonth, '02') + format(WhichDoM, '02') + '_ClimGrid1D.npz')
