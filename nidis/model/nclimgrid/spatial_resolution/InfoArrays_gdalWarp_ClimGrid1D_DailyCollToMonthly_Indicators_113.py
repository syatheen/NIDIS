...
def main(ArgYearInt: int, ArgMonthInt: int):
  ...
  # os.system(cmd)
  path_to_save_data = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/GlobSnow3_Npzs'
  os.makedirs(path_to_save_data, exist_ok=True)

  ArrayFileName = os.path.join(
     path_to_save_data, 'GlobSnow3_' + format(ArgYearInt,'04') + format(ArgMonthInt,'02') + '_ClimGrid1D.npz')

  SourceFileBasePath = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/OriginalData/GlobSnow'
  SourceFileBasePathWrite = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/GlobSnow3'
