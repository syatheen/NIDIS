...
def main(ArgYearInt: int, ArgMonthInt: int):
  ...
  # os.system(cmd)
  path_to_save_data = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/ESA_CCI_Npzs'
  ...
  SourceFileBasePath = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/Indicator_97/Original_Data'
  SourceFileBasePathWrite = '/discover/nobackup/projects/nca/jacaraba/NIDIS_Data/ESA_CCI/daily_Final_V06_Tifs'
