...
def main(
    ...
    if SpatialDomain in ['CONUS']:
        ...
        if TargetVariable == 'USDM':
            ...
            SingleUnifiedDataFilename_BlendedVHP_MonthlyPerc = f'{temp_path_npz_Soni}/PreppedTrainNEvalNpzs/ClimGrid1D/SingleUnified_BlendedVHP_Corr2MonthlyPerc_20030930To20201229.npz'
